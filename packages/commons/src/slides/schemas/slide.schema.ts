...
export const SlideSchema = SlideBaseSchema.safeExtend({
	id: UuidSchema,
...
export const ViewSlideSchema = SlideBaseSchema.safeExtend({
	id: UuidSchema,
})
	.refine(slideDateRefinement.refine, slideDateRefinement.params)
	.refine(slideCouponCodeRefinement.refine, slideCouponCodeRefinement.params)
...
/** Create payload */
const CreateSlideBodySchema = SlideBaseSchema.extend({
...
export const CreateSlideSchema = CreateSlideBodySchema.refine(
	slideDateRefinement.refine,
	slideDateRefinement.params,
)
	.refine(slideCouponCodeRefinement.refine, slideCouponCodeRefinement.params)
	.refine(slideRedirectRefinement.refine, slideRedirectRefinement.params);

/** Update payload */
const UpdateSlideBodySchema = SlideBaseSchema.partial().refine(
...
export const UpdateSlideSchema = UpdateSlideBodySchema.refine(
	slideDateRefinement.refine,
	slideDateRefinement.params,
)
	.refine(slideCouponCodeRefinement.refine, slideCouponCodeRefinement.params)
