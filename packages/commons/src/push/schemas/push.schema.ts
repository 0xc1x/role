...
export const UpdatePushTemplateSchema = PushTemplateSchema.partial().refine(
...
export const CreatePushSendSchema = PushPayloadSchema.extend(
	PushAudienceSchema.shape,
).refine((v) => v.segment_ids.length > 0 || v.include_user_ids.length > 0, {
...
export const PushNotificationListResponseSchema = PaginatedDataSchema(
...
export const PushTokenListResponseSchema =
	PaginatedDataSchema(PushTokenDtoSchema);
...
export const PushTemplateListResponseSchema = PaginatedDataSchema(
