...
import { slidesListOptions, useSlideList } from '@/features/slides/queries/slides.queries';
import { createFileRoute } from '@tanstack/react-router'
import { Search } from 'lucide-react';
import { useEffect, useState } from 'react';
import { slidesColumns } from "@/features/slides"
import { ListSlidesQuerySchema } from "@0xc1x/role-commons";
...
export const Route = createFileRoute('/_layout/slides')({
    ...
    loader: ({ context, deps }) =>
        context.queryClient.ensureQueryData(slidesListOptions({ ...deps, type: "ad" })),
...
function RouteComponent() {
    ...
    const { data, isLoading, isError, error } = useSlideList({ ...search, type: "ad" });
