...
export const offers = pgTable(
  ...
  (table) => [
    foreignKey({
      columns: [table.business_location_id, table.business_id],
      foreignColumns: [businessLocations.id, businessLocations.business_id],
      name: 'offers_location_business_fkey',
    }).onDelete('restrict'),
  ],
);
