...
function Button({
  ...
  // Native tokens: CSS vars (bg-primary, etc.) resolve to light values on
  // native because .dark only toggles on web. style carries the theme.
  // className stays as web enhancement.
  ...
  const variantStyle: ViewStyle = (() => {
    switch (resolvedVariant) {
      ...
      case 'outline':
        return { backgroundColor: colors.inputBackground, borderColor: colors.borderSolid };
      case 'secondary':
  ...
  const pressableStyle: React.ComponentProps<typeof Pressable>["style"] =
    typeof style === 'function'
      ? (state: PressableStateCallbackType) => [variantStyle, style(state)]
      : [variantStyle, style];
