...
export const strings = {
	...
	orders: {
		...
		cardPickupAt: "{date} · {time} hs",
		detailTitle: "Detalle del pedido",
		statusTitle: "Estado del pedido",
		businessTitle: "Comercio",
		copyCode: "Copiar",
		codeCopied: "¡Código copiado!",
		cancelHint: "Puedes cancelar sin costo hasta que el pedido esté listo",
		pickupStepWait: "Espera la notificación «Listo para retirar»",
		pickupStepWindow: "Ventana de retiro: {window}",
		pickupStepGoTo: "Dirígete a {address}",
		pickupStepShowCode: "Presenta el código {code} o escanea el QR",
		pickupStepDone: "Valida tu pedido y ¡listo!",
		status: "Estado",
		created: "Creado",
		pickup: "Recogida",
		...
		moneySaved: "Ahorraste {saved} con tu compra.",
		...
		instructionsBody:
			"Acércate al local dentro del rango horario indicado. No olvides presentar tu código.",
		...
		myReviewsEmptyHint:
			"Cuando completes un pedido podrás dejar tu opinión aquí.",
		editReview: "Editar reseña",
		saveReviewChanges: "Guardar cambios",
		reviewUpdated: "Reseña actualizada",
		deleteReview: "Eliminar reseña",
		deleteReviewConfirm:
			"¿Eliminar esta reseña? Esta acción no se puede deshacer.",
		deleteReviewError: "No se pudo eliminar la reseña",
		reviewDeleted: "Reseña eliminada",
		orderReviewTitle: "Reseña del pedido",
		orderAmount: "Monto",
		youSaved: "Ahorraste",
	...
	business: {
		...
		businessLogo: "Logo",
		businessCover: "Portada",
		businessZone: "Zona (opcional)",
		...
		locationPicked: "Ubicación seleccionada",
		revenue: "Ingresos",
		ordersCount: "Pedidos",
		...
		quickReviews: "Reseñas",
		quickReviewsSub: "Opiniones",
		quickAlerts: "Alertas",
