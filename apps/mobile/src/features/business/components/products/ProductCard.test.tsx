...
const product: OfferDetail = {
	offer: {
		id: "offer-1", business_id: "business-1", business_location_id: "branch-1",
		title: "Artisan bread selection for collection", description: null, image: null,
		category_ids: [], original_price: 150, discounted_price: 65, discount_percentage: null,
		stock: 0, initial_stock: 8, pickup_start: "2026-09-06T15:00:00",
		pickup_end: "2026-09-06T18:00:00", is_active: true, includes: null,
		allergens: null, rating: 0, review_count: 0,
		created_at: "2026-09-01T12:00:00", updated_at: "2026-09-01T12:00:00",
	},
	business: { id: "business-1", name: "Bakery", type: "bakery", image: null, rating: 0, review_count: 0 },
	location: { id: "branch-1", name: "Historic city centre collection branch", address: "Centre", latitude: 0, longitude: 0, zone: null },
	categories: [],
};
...
test("renders metadata and independent footer buttons in both themes, including zero stock", () => {
	for (const palette of [light, dark]) {
		colors = palette;
		const html = renderToStaticMarkup(createElement(ProductCard, { businessId: "business-1", product }));
		...
		expect(renderToStaticMarkup(createElement(ProductCardSkeleton))).not.toBeEmpty();
	}
	const inactive = { ...product, offer: { ...product.offer, is_active: false, initial_stock: 0 } };
	const html = renderToStaticMarkup(createElement(ProductCard, { businessId: "business-1", product: inactive }));
